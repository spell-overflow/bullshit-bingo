...
export default function Home() {
  return (
    <div>
      ...
      <div className="prose dark:prose-invert mx-auto my-4 max-w-3xl rounded-xl bg-accent p-4 pt-2 text-accent-foreground sm:px-6 lg:max-w-5xl lg:px-8">
        ...
        <p>
          ...
          Am Tannenkamp 15
          <br />
          49088 Osnabr&uuml;ck
        </p>
        <p>
          Telefon: 0541-97332405
          <br />
          E-Mail: annekehugenberg@proton.me
        </p>
        <p>
        ...
        <p>
          ...
          (nachfolgend Gravatar).
        </p>{" "}
        <p>
          Gravatar ist ein Tool, das es erm&ouml;glicht, pers&ouml;nliche Bilder
          (Avatare) f&uuml;r die Nutzer unserer Website bereitzustellen. Die
          Avatare dienen als visuelle Repr&auml;sentationen der Nutzer und
          werden &uuml;berall dort angezeigt, wo ein Nutzer mit der Plattform
          interagiert (z.&nbsp;B. in Foren oder Chats). Wenn ein Nutzer mit der
          Plattform interagiert, wird sein Avatar basierend auf der mit seiner
          E-Mail-Adresse verkn&uuml;pften Auswahl angezeigt. Dies verleiht der
          Online-Pr&auml;senz der Nutzer eine pers&ouml;nliche Note und
          erleichtert die Identifizierung, da das gew&auml;hlte Bild den Nutzern
          zugeordnet wird, wenn sie online aktiv sind.
        </p>{" "}
        <p>
          Wenn Sie auf unserer Website kommentieren bzw. interagieren und dabei
          Gravatar aktiviert ist, wird der Hash der E-Mail-Adresse des Nutzers,
          der Gravatar nutzt (wird als ID genutzt) von Gravatar verarbeitet.
        </p>{" "}
        <p>
          Die Verwendung von Gravatar erfolgt auf Grundlage von Art. 6 Abs. 1
          lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an
          einer ansprechenden Darstellung seiner Foren. Sofern eine
        ...
        <p>
          Weitere Details entnehmen Sie der Datenschutzerkl&auml;rung des
          Anbieters unter{" "}
          <a
