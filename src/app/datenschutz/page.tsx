    ...
    <div className="mx-auto">
      ...
      <div className="my-4 rounded-lg bg-accent p-4 text-card-foreground shadow">
        <div className="prose dark:prose-invert">
          ...
          <p>
            Gravatar ist ein Tool, das es erm&ouml;glicht, pers&ouml;nliche
            Bilder (Avatare) f&uuml;r die Nutzer unserer Website
            bereitzustellen. Die Avatare dienen als visuelle
            Repr&auml;sentationen der Nutzer und werden &uuml;berall dort
            angezeigt, wo ein Nutzer mit der Plattform interagiert (z.&nbsp;B.
            in Foren oder Chats). Wenn ein Nutzer mit der Plattform interagiert,
            wird sein Avatar basierend auf der mit seiner E-Mail-Adresse
            verkn&uuml;pften Auswahl angezeigt. Dies verleiht der
            Online-Pr&auml;senz der Nutzer eine pers&ouml;nliche Note und
            erleichtert die Identifizierung, da das gew&auml;hlte Bild den
            Nutzern zugeordnet wird, wenn sie online aktiv sind.
          </p>{" "}
          <p>
            Wenn Sie auf unserer Website kommentieren bzw. interagieren und
            dabei Gravatar aktiviert ist, wird der Hash der E-Mail-Adresse des
            Nutzers, der Gravatar nutzt (wird als ID genutzt) von Gravatar
            verarbeitet.
          </p>{" "}
          <p>
            ...
            und &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit
            widerrufbar.
          </p>{" "}
          <p>
